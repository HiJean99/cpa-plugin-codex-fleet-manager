...
.cardActions{gap:8px}.pinAccount{display:inline-flex;align-items:center;justify-content:center;padding:9px;color:#6b7280}.pinAccount.pinned{background:#dbeafe;color:#2563eb}.pinAccount svg{width:18px;height:18px;fill:currentColor}
</style>
</head>
<body>
<div class="shell">
